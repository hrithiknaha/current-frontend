            ...
            <div key={episode.episode_id} className="bg-white rounded-lg shadow-md p-4 mt-3">
                ...
                <div className="flex items-center justify-between">
                    <div className="text-center">
                        <p className="text-gray-600">Episdoe:</p>
                        <p className="text-lg lg:text-2xl font-semibold">{episode.episode_number}</p>
                    </div>
                    <div className="text-center">
                        <p className="text-gray-600">Watched:</p>
                        <p className="text-lg lg:text-2xl font-semibold">{moment(episode.date_watched).fromNow()}</p>
                    </div>
                    <div className="text-center">
                        <p className="text-gray-600 float-right">Verdict:</p>
                        <p className="text-lg lg:text-2xl font-semibold">{getVerdict(episode.rating)}</p>
                    </div>
                </div>
            </div>
        </Link>
